...
@EnableJpaRepositories("ru.geekbrains.entity")
public class AppPersistConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/hm4_products_db?createDatabaseIfNotExist=true&allowPublicKeyRetrieval=" +
                "true&useSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
        dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
        dataSource.setUsername("root");
        dataSource.setPassword("jcq19w3g");
        return dataSource;
    }
